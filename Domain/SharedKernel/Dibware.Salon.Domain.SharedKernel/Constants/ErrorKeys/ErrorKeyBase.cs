//-----------------------------------------------------------------------
// <copyright file="ErrorKeyBase.cs" company="Dibware">
...
namespace Dibware.Salon.Domain.SharedKernel.Constants.ErrorKeys
{
    ...
    public abstract class ErrorKeyBase
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ErrorKeyBase"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Tries to parses the specified formatted key. If it succeeds then a tuple containing the
